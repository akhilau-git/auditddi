...
| **Model Serving State** | API clearly distinguishes between legacy baseline checkpoint (`auditddi_model.pt`) and new multimodal artifacts. Production release requires explicit reviewed checkpoint promotion. |
